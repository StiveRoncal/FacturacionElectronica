<?php
        ...
        if(empty($_POST['proveedor']) || empty($_POST['producto']) || empty($_POST['precio']) || empty($_POST['id']) || empty($_POST['foto_actual']) || empty($_POST['foto_remove'])){
            ...
            $query_update = mysqli_query($conection,"UPDATE producto
                ...
                if($query_update){
                    ...
                    //determinar foto si se esta actualizado
    ...
    //Validar id de Producto contra numero no existentes y caracteres 
    if(empty($_REQUEST['id'])){
        ...
        //VAlidacion de foto para evitar si tiene o no
        $foto = '';
	...
	<section id="container">
        ...
        <div class="form_register">
            ...
            ?>
                ...
                <input  step="any" type="number" name="precio" id="precio" placeholder="Precio del Producto" value="<?php echo $data_producto['precio'];?>">
