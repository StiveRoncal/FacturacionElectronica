...
<div id="page_pdf">
		...
		<tr>
			...
			<td class="info_empresa">
				...
				<div>
					...
					<p>Correo: <?php echo $configuracion['email']; ?></p>
				</div>
				<?php
					}
				 ?>
			...
			<td class="info_factura">
				<div class="round">
					...
					<p>No. Venta: <strong><?php echo $factura['nofactura']; ?></strong></p>
	...
	<div>
		<p class="nota">Este Comprobante no Tiene Relación con SUNAT <br>Venta de Materiales de Instalación Electrica y Vinos De Calidad</p>
